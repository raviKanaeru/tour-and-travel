    ...
    <div class="row">
      ...
      <div class="col s9" style="padding-right: 0; padding-left: 0; /*height: 992px;*/ float: right;">
        ...
        <div class="card-content black-text">
          ...
          <hr>
          <a href="tambahtour.php" class="waves-effect waves-light btn blue" style="margin-top: 20px; margin-bottom: 20px;"><i class="material-icons left">add</i>Tambah Tour</a>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><img class="responsive-img" width="80px" height="80px" src="tour/<?php echo $data["gambar"]; ?>"></td>
            <td><?php echo $data["harga"]; ?></td>
            <td><?php echo $data["lokasi"]; ?></td>
            <td><?php echo $data["durasi"]; ?></td>
            <td><a href="hapustour.php?id=<?php echo $data["id_tour"]; ?>" class="waves-effect waves-light btn">Hapus</a>
          </tr>
          <?php $i++; ?>
        <?php endforeach; ?>
