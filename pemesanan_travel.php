...
$info = query("SELECT * FROM pesanan_travel WHERE username = '$username'");
                    ...
                    <tbody>
                      ...
                      <?php foreach($info as $data) :?>
                        <tr>
                          ...
                          <td><?php $tanggal = $data["tanggal_berangkat"]; 
                            echo date("l, d-F-Y", strtotime($tanggal)); ?></td>
                          <td><?php echo $data["status"]; ?></td>
                          <td><a href="cancel_travel.php?id=<?php echo $data["nomor_pemesanan"]; ?>">Cancel</a>
                              <a href="view_travel.php?id=<?php echo $data["nomor_pemesanan"]; ?>">View</a>
                          </td>
                        </tr>
                      <?php $id++; ?>
                      <?php endforeach; ?>
