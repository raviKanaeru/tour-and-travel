...
$pesan = query("SELECT * FROM pesanan_tour WHERE nomor_pemesanan = $id");
			...
			<div class="row">
			    ...
			    <div class="col s12 m6 offset-m3">
			      <div class="card-panel">
			        ...
			        <p><b>Nama Paket Pemesanan : </b><?php echo $info["nama_tour"]; ?></p>
			        ...
			        <p><b>Tanggal Keberangkatan : </b><?php $tanggal = $info["tanggal_berangkatan"];
